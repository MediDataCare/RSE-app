        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>MediData<span>Care<i class="fas fa-plus-circle"></i></span></h3>
              <p>
         ...
         <!-- <div class="col-lg-3 col-md-6 footer-links">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            <h4>Newsletter</h4>
            <p>Subscreva a nossa Newsletter e acompanhe o impacto da tecnologia MediDataCare nos avanços da Medicina.</p>
    ...
    <div class="footer-legal text-center">
      <div class="container d-flex flex-column flex-lg-row justify-content-center justify-content-lg-between align-items-center">
        ...
        <div class="d-flex flex-column align-items-center align-items-lg-start">
          <div class="copyright">
            &copy; Copyright <strong><span>MediDataCare</span></strong>. All Rights Reserved
          </div>
          <div class="credits">
